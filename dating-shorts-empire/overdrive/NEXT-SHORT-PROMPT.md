...
- Character: reference element `Ace-Painterly-Master` (id `da97c09d-5ba0-47e7-b3f4-a5100ccbcefe`) — embed `<<<da97c09d-5ba0-47e7-b3f4-a5100ccbcefe>>>` in every avatar image prompt. Master sheet: `channel-identity/master-character-sheet-USER-FINAL.png`. Style tokens: "semi-realistic illustration, clean linework, soft painterly airbrushed shading, realistic athletic adult proportions, warm peach #F2C4A0 background". NEVER the old flat-vector style.
- Voice: **see `channel-identity/VOICE-LOCK.md`** — Xavier via ElevenLabs (`text2speech_v2`, `variant:"elevenlabs"`, voice_id `43173c95-3ec8-446a-a162-6504332c578b`, preset). Generate in 2-4 full-sentence takes, concat + tempo-fit under 60s. Do NOT use plain seed_audio OR voice_change conversion (both rejected as robotic).
